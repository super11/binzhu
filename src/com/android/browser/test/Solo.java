...
public class Solo {
	...
	public View waitForViewFromText(String text){
	...
	//add by zhubin 
	public void clickOnWebElement(String textName, int match, boolean scroll){
		clicker.clickOnWebElement(textName, match, scroll);
	}
	...
	public boolean imageCompare(String path1, String path2,int xpath,int ypath,int rate){
		return ImageCompare.compareImage(path1, path2,xpath,ypath,rate);
