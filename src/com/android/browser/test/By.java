...
public abstract class By {
	...
	//add by zhubin to getFrameSrc value
	public static By getFrameSrc(final String id){
		return new GetFrameSrc(id);
	}
	//add by zhubin
	public static By checkbox(final String id){
		return new CheckBox(id);
	}
	//add by zhubin
	public static By getFrameItem(final String id,final String tagName){
		return new GetFrameItem(id,tagName);
	}
	...
	//add by zhubin to get frameSrcValue
	static class GetFrameSrc extends By {
		private final String id;
		
		public GetFrameSrc(String id){
			this.id=id;
		}
	...
	static class CheckBox extends By {
		private final String id;
	...
	//add by Zhubin
		static class GetFrameItem extends By {
			private final String id;
			private final String tagName;
			
			public GetFrameItem(String id,String tagName){
				this.id = id;
